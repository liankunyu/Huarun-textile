...
procedure TFrmBGYXG.btnCancelClick(Sender: TObject);
begin
  Self.Close;
end;

procedure TFrmBGYXG.FormShow(Sender: TObject);
begin
  if Self.Tag=1 then
  begin
...
procedure TFrmBGYXG.btnSaveClick(Sender: TObject);
begin
  if Self.Tag=1 then
  begin
    with DM.qrygyhz do
...
procedure TFrmBGYXG.RzToolButton1Click(Sender: TObject);
var
 bmp1:TBitmap;
 jpg1:TJpegImage;
begin
...
procedure TFrmBGYXG.frxrprtCraftInfoBeforePrint(
  Sender: TfrxReportComponent);
begin
 //TfrPictureView(frxrprtCraftInfo.FindObject('picture1')).Picture.LoadFromFile('e:\qq.jpg');
end;

procedure TFrmBGYXG.RzDBEdit1Change(Sender: TObject);
var
  jxjd:string;
  wxjd:string;
  pszl:string;
