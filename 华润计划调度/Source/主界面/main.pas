...
begin
    ...
    RzGroup1.Items[0].Selected:=False;
end;
...
begin
  LoadDll('KCXX.dll','pzbkcyj');                         //织布库存预警
      RzGroup1.Items[2].Selected:=False;
end;
...
begin
  LoadDll('JTXX.dll','pbjfb');                        //织布分场布机分布信息
      RzGroup8.Items[0].Selected:=False;
end;
...
begin
 ...
 RzGroup8.Items[6].Selected:=False;
end;
...
begin
  ...
  RzGroup3.Items[0].Selected:=False;
end;
...
begin
  LoadDll('DDKZ.dll','pbjhdd');                        //织布生产计划调度信息
    RzGroup3.Items[2].Selected:=False;
end;
